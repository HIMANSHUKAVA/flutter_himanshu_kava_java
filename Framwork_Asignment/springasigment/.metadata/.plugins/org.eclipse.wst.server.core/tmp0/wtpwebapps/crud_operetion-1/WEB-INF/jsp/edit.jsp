...
<div class="container mt-5">
    ...
    <form action="updateEmployee" method="post">
        ...
        <div class="form-group">
            <label>Email</label>
            <input type="email" name="email" value="<%= p.getEmail() %>" class="form-control" required>
        </div>
        ...
        <div class="form-group">
            <label>Phone</label>
            <input type="text" name="phone" value="<%= p.getPhone() %>" class="form-control" required>
        </div>
